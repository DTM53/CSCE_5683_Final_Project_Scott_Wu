...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input_pairs', type=str, default='C:/Users/FORMULA/OneDrive - University of Arkansas/Desktop/formatted_pairs.txt',
        help='Path to the list of image pairs')
    parser.add_argument(
        '--input_dir', type=str, default='D:/DATA/images/',
        help='Path to the directory that contains the images')
    parser.add_argument(
        '--output_dir', type=str, default='D:/Program Files (x86)/PhD/STUDY/IP 2024 spring',
